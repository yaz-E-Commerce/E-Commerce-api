...
const shopSettingsSchema = new mongoose.Schema({
  ...
  subscription: {
    type: {
      ...
      currentPeriodEnd: { type: Date, required: true, default: () => new Date(Date.now() + 30*24*60*60*1000) }, // افتراضي شهر واحد
    },
    _id: false
  },
  ...
  rating: { type: shopRatingSchema, default: { average: 0, count: 0 } },
  performance: { type: merchantPerformanceSchema, default: { responseTimeMinutes: 0, completionRate: 100 } },
